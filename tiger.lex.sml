...
fun yyAction43 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.INT(makeint yytext handle Overflow => (err(yypos, "Overflow: integer " ^ yytext ^ " too large"); MaxInt), yypos, yypos + size(yytext)))
      end
fun yyAction44 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; instring := true; trstr := ""; com_str_start := yypos; continue()))
fun yyAction45 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (trstr :=  !trstr ^ yytext;continue())
      end
...
fun yyAction53 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (dolinepos(yypos,map str (explode(yytext)));continue())
      end
fun yyAction54 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; instring := false; Tokens.STRING(!trstr,!com_str_start,size(!trstr))))
...
fun yyAction61 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (err(yypos, "Syntax Error " ^ yytext);continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction42(strm, yyNO_MATCH)
                      else yyQ67(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ72(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ46 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction35(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ113(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ112(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
...
fun yyQ44 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ114(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
...
and yyQ16 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\\"
              then yyQ17(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
...
and yyQ10 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
and yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yystuck(lastMatch)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ19(strm', lastMatch)
        ...
        | SOME(inp, strm') =>
            if inp = #"1"
              ...
              then if inp = #"]"
                  ...
                  else yyQ13(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp = #"o"
              then yyAction55(strm, yyNO_MATCH)
            else if inp < #"o"
              then if inp = #"n"
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\\"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ23(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"~"
              then yyQ23(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
